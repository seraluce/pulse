export const zh = {
  ...
  features: {
    ...
    items: [
      ...
      { title: "技术支持", desc: "专业团队全程指导，从安装到上线的全流程技术支持", icon: "support" },
    ],
  },
  highlights: {
    header: {
  ...
  pages: {
    about: {
      ...
      team: {
        ...
        members: [
          { name: "Evan", role: "创始人 & 技术负责人", bio: "全栈开发者，5 年 AI 部署经验，精通各类 Agent 框架" },
          { name: "Alex", role: "运维总监", bio: "前 DevOps 工程师，精通容器化部署和自动化运维" },
          { name: "Lisa", role: "客户成功经理", bio: "3 年技术客户服务经验，确保每个项目顺利交付" },
          { name: "Tom", role: "AI 工程师", bio: "专注 AI Agent 开发与 API 集成，擅长主流 LLM 框架" },
        ],
      },
    },
    services: {
    ...
    contact: {
      ...
      form: {
        ...
        message: "需求描述",
        messagePlaceholder: "请描述您的部署需求...",
        submit: "发送需求",
        success: "需求已收到，我们会尽快与您联系！",
        fail: "发送失败，请稍后重试",
        required: "请填写所有必填项",
        sending: "发送中...",
